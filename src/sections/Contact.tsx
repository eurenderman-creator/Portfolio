    ...
    <section id="contact" className="section-padding bg-[#F8F8F8]">
      <div className="container-main">
        ...
        <div className="text-center mb-20 md:mb-32">
          ...
          <p className="text-[16px] md:text-[18px] text-[#666666] font-body max-w-xl mx-auto">
            {contactData.ctaText}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-20 md:mb-32">
          ...
          <div className="text-center">
            ...
            <p className="text-label text-[#999999] mb-2">PHONE</p>
            <a
        ...
        <div className="border-t border-[#E5E5E5] pt-12">
          ...
          <div className="flex items-center justify-center gap-8 md:gap-12">
            <a
              ...
              className="group flex items-center gap-2 text-[#111111] hover:opacity-70 transition-opacity"
            >
              <span className="text-[14px] font-medium uppercase tracking-[2px] font-body">
                X (Twitter)
              </span>
              <ExternalLink
                size={14}
        ...
        <div className="mt-12 text-center">
          <p className="text-[13px] text-[#999999] font-body">
      ...
      <footer className="container-main mt-20 md:mt-32 pt-8 border-t border-[#E5E5E5]">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button
            onClick={scrollToTop}
            className="group flex items-center gap-2 text-[12px] font-medium uppercase tracking-[2px] text-[#999999] hover:text-[#111111] transition-colors font-body"
          >
            BACK TO TOP
            <ArrowUp
              size={14}
